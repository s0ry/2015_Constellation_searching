...
/*int CDECL Pro_Compare(KScScalarImage2dUint8* src,KScScalarImage2dUint8* ref,KScScalarImage2dUint8* dst)*/
/*int CDECL Pro_Compare(KScRgbImage2d* src,KScRgbImage2d* ref,KScRgbImage2d* dst)*/
/*int CDECL Pro_Compare(KScScalarImage2dUint8* src,KScScalarImage2dUint8* ref,KScScalarImage2dUint8* dst)*/
